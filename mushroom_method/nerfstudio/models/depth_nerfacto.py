...
class DepthNerfactoModelConfig(NerfactoModelConfig):
    ...
    starting_depth_sigma: float = 0.02
...
class DepthNerfactoModel(NerfactoModel):
    ...
    def get_outputs(self, ray_bundle: RayBundle):
        ...
        outputs["directions_norm"] = ray_bundle.directions_norm
        return outputs
    ...
    def get_image_metrics_and_images(
        ...
        metrics, images = super().get_image_metrics_and_images(outputs, batch, n)
