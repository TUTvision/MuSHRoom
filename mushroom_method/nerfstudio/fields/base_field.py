...
class Field(nn.Module):
    ...
    @abstractmethod
    def get_outputs(
        self, ray_samples: RaySamples, density_embedding: Optional[TensorType] = None, comptue_normals: bool = False
    ...
    def forward(self, ray_samples: RaySamples, compute_normals: bool = False):
        ...
        field_outputs = self.get_outputs(ray_samples, compute_normals)
