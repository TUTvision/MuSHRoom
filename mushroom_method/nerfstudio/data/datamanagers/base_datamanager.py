...
from nerfstudio.data.dataparsers.vr_nerfstudio_dataparser import VRNerfstudioDataParserConfig
from nerfstudio.data.dataparsers.vr_sdfstudio_dataparser import VRSDFStudioDataParserConfig
...
AnnotatedDataParserUnion = tyro.conf.OmitSubcommandPrefixes[  # Omit prefixes of flags in subcommands.
    tyro.extras.subcommand_type_from_defaults(
        {
            "vrsdfstudio-data": VRSDFStudioDataParserConfig(),
            "vrnerfstudio-data": VRNerfstudioDataParserConfig(),
