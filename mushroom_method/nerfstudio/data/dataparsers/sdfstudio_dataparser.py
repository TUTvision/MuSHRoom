...
class SDFStudio(DataParser):
    ...
    def _generate_dataparser_outputs(self, split="train"):  # pylint: disable=unused-argument,too-many-statements
        ...
        # load image names
        pose_meta = load_from_json(self.config.data / ".." / "transformations.json")
        frame_names = [frame["file_path"].split("/")[-1].split(".")[0] for frame in pose_meta["frames"]]
        ...
        print("train images: ", len(i_train), "eval images: ", len(i_eval))
