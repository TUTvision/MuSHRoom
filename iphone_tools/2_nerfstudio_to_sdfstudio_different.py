...
def main(args):
    ...
    cam_params = json.load(open(input_dir / "transformations_colmap.json"))
    ...
    for frame in frames:
        ...
        if args.sensor_depth:
            depth_path = input_dir / "depth" / f"{file_path.stem}.png"
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--pose_scale",
        help="use training data or all data to rescale pose",
    )
